...
import ShopProductSingle from '@/components/pages/shop/ShopProductSingle'
...
export default new Router({
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'ShopProductSingle/:p_id',
          name: 'shop.ShopProductSingle',
          component: ShopProductSingle
        },
        {
          path: 'checkout',
          name: 'shop.checkout',
  ...
  mode: 'history', //for not showing '/#/' in url
})
